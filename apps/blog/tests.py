...
class CategoryModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # With the below, you can refer to the category as self.category in any test methods
...
#             username="Pythonian", email="pythonian@gmail.com", password="pythonian"
#         )
...
#         self.assertEqual(self.post.title, "A new post")
#         self.assertEqual(self.post.body, "A post content")
#         self.assertEqual(self.post.author.username, "Pythonian")
#         self.assertEqual(str(self.post), "A new post")
#         self.assertEqual(self.post.get_absolute_url(), "/post/1/")

#     def test_url_exists_at_correct_location_postdetailview(self):
