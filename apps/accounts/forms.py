...
class CompanySignupForm(UserCreationForm):
    ...
    established = forms.DateField(widget=forms.TextInput(attrs={"type": "date", "class": "form-control"}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(Column("about", css_class="form-group col-12"), css_class="form-row"),
...
class EmployeeSignUpForm(UserCreationForm):
    ...
    class Meta(UserCreationForm.Meta):
        model = User
        # fields = UserCreationForm.Meta.fields + ("new_field")
...
# class UserEmployeeEditForm(UserChangeForm):
